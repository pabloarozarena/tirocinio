...
To avoid short sequences and fetch actual genes or genomes we can filter by sequence length. In this case we are looking for sequences between 10kb and 20kb:
